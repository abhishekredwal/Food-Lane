...
<body>
	<div class="signin">
	<form  name="myform" method="post" action="signin.php" onsubmit="return validate()">
	<h2 style="color:white">Log In</h2>
	<input type="text" name="email" placeholder="Email-Id"><span id="emailerror" style="color:red;"></span>
	<input type="password" name="password" placeholder="Password"><br><br><span id="passworderror" style="color:red;"></span>
